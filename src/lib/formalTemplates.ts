...
export const formalTemplates: FormalTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/formal/formal_black_tie.webp?v=1',
    background: '/invitation-templates/formal/formal_black_tie.webp?v=1'
  },
  {
    id: 'formal_ivory',
    name: 'Marfil',
    ...
    thumbnail: '/invitation-templates/formal/formal_ivory.webp?v=1',
    background: '/invitation-templates/formal/formal_ivory.webp?v=1'
  },
  {
    id: 'formal_executive',
    name: 'Ejecutivo',
    ...
    thumbnail: '/invitation-templates/formal/formal_executive.webp?v=1',
    background: '/invitation-templates/formal/formal_executive.webp?v=1'
  }
];
