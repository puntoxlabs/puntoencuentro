...
export const formalTemplates: FormalTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/formal/formal_black_tie_v2.webp?v=2',
    background: '/invitation-templates/formal/formal_black_tie_v2.webp?v=2'
  },
  {
    id: 'formal_ivory',
    name: 'Marfil',
    ...
    thumbnail: '/invitation-templates/formal/formal_ivory_v2.webp?v=2',
    background: '/invitation-templates/formal/formal_ivory_v2.webp?v=2'
  },
  {
    id: 'formal_executive',
    name: 'Ejecutivo',
    ...
    thumbnail: '/invitation-templates/formal/formal_executive_v2.webp?v=2',
    background: '/invitation-templates/formal/formal_executive_v2.webp?v=2'
  }
];
