...
export const familyTemplates: FamilyTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/family/family_home_v3.webp?v=4',
    background: '/invitation-templates/family/family_home_v3.webp?v=4'
  },
  {
    id: 'family_sunday',
    name: 'Domingo',
  ...
  },
  {
    ...
    thumbnail: '/invitation-templates/family/family_memories_v3.webp?v=4',
    background: '/invitation-templates/family/family_memories_v3.webp?v=4'
  }
];
