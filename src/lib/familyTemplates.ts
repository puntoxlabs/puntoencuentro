...
export const familyTemplates: FamilyTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/family/family_home_v2.webp?v=3',
    background: '/invitation-templates/family/family_home_v2.webp?v=3'
  },
  {
    id: 'family_sunday',
    name: 'Domingo',
    ...
    thumbnail: '/invitation-templates/family/family_sunday_v2.webp?v=3',
    background: '/invitation-templates/family/family_sunday_v2.webp?v=3'
  },
  {
    id: 'family_memories',
    name: 'Recuerdos',
    ...
    thumbnail: '/invitation-templates/family/family_memories_v2.webp?v=3',
    background: '/invitation-templates/family/family_memories_v2.webp?v=3'
  }
];
