...
export const entertainmentTemplates: EntertainmentTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/entertainment/entertainment_cinema_v4.webp?v=4',
    background: '/invitation-templates/entertainment/entertainment_cinema_v4.webp?v=4'
  },
  {
    ...
    thumbnail: '/invitation-templates/entertainment/entertainment_music_v4.webp?v=4',
    background: '/invitation-templates/entertainment/entertainment_music_v4.webp?v=4'
  },
  {
    ...
    thumbnail: '/invitation-templates/entertainment/entertainment_show_v4.webp?v=4',
    background: '/invitation-templates/entertainment/entertainment_show_v4.webp?v=4'
  }
];
