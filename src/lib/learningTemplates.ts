...
export const learningTemplates: LearningTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/learning/learning_class_v1.webp?v=1',
  ...
  },
  {
    ...
    thumbnail: '/invitation-templates/learning/learning_talk_v1.webp?v=1',
    background: '/invitation-templates/learning/learning_talk_v1.webp?v=1'
  }
];
