...
export const learningTemplates: LearningTemplateConfig[] = [
  {
    ...
    background: '/invitation-templates/learning/learning_class_bg_v7.webp?v=7'
  },
  {
    id: 'learning_course',
    name: 'Curso',
    ...
    background: '/invitation-templates/learning/learning_course_bg_v7.webp?v=7'
  },
  {
    id: 'learning_talk',
    name: 'Charla',
    ...
    background: '/invitation-templates/learning/learning_talk_bg_v7.webp?v=7'
  }
];
