...
export const learningTemplates: LearningTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/learning/learning_class_v3.webp?v=3',
    background: '/invitation-templates/learning/learning_class_v3.webp?v=3'
  },
  {
    id: 'learning_course',
    name: 'Curso',
    ...
    thumbnail: '/invitation-templates/learning/learning_course_v3.webp?v=3',
    background: '/invitation-templates/learning/learning_course_v3.webp?v=3'
  },
  {
    id: 'learning_talk',
    name: 'Charla',
    ...
    thumbnail: '/invitation-templates/learning/learning_talk_v3.webp?v=3',
    background: '/invitation-templates/learning/learning_talk_v3.webp?v=3'
  }
];
