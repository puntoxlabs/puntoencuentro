...
export const learningTemplates: LearningTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/learning/learning_class_v2.webp?v=2',
    background: '/invitation-templates/learning/learning_class_v2.webp?v=2'
  },
  {
    id: 'learning_course',
    name: 'Curso',
    ...
    thumbnail: '/invitation-templates/learning/learning_course_v2.webp?v=2',
    background: '/invitation-templates/learning/learning_course_v2.webp?v=2'
  },
  {
    id: 'learning_talk',
    name: 'Charla',
    ...
    thumbnail: '/invitation-templates/learning/learning_talk_v2.webp?v=2',
    background: '/invitation-templates/learning/learning_talk_v2.webp?v=2'
  }
];
