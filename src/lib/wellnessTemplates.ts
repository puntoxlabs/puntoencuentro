...
export const wellnessTemplates: WellnessTemplateConfig[] = [
  {
    ...
    thumbnail: '/invitation-templates/wellness/wellness_calm_v3.webp?v=3',
    background: '/invitation-templates/wellness/wellness_calm_v3.webp?v=3'
  },
  {
    id: 'wellness_nature',
    name: 'Aire libre',
    ...
    thumbnail: '/invitation-templates/wellness/wellness_nature_v3.webp?v=3',
    background: '/invitation-templates/wellness/wellness_nature_v3.webp?v=3'
  },
  {
    ...
    thumbnail: '/invitation-templates/wellness/wellness_movement_v3.webp?v=3',
    background: '/invitation-templates/wellness/wellness_movement_v3.webp?v=3'
  }
];
