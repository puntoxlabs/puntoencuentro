  ...
  if (participante.estado !== 'pendiente') {
    return (
      <ScreenContainer>
        ...
        <EmptyState 
          title={participante.estado === 'confirmado' ? '¡Asistencia confirmada!' : 'Marcaste que no podés asistir'}
          description={`Gracias por confirmar, ${participante.nombre_invitado}.`}
        />
